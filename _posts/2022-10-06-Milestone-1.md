...
So we can say these shots from these distances were the most dangerous ones.
Also looking at the figure we can easily see that the higher lines are mostly of the colors green and orange which are
for the shot types Tip-in and Deflected respectively. So we can say these 2 shots are the most dangerous shots in general(in season 2018).
