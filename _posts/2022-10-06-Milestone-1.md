...
Using the GAME_ID we have, we can substitute it in the URL we have:
	...
	This way we can have all the data in the url in r variable.
...
![data aquisition example-output](../public/q1-example output.png)
...
**Solution:**
![Season_2018.png](../public/Season_2018.png)
...
**Solution:**
![5c-zoom.png](../public/5c-zoom.png)
...
[2016_visualization.html](../_layouts/2016_visualization.html) \
[2017_visualization.html](../_layouts/2017_visualization.html) \
[2018_visualization.html](../_layouts/2018_visualization.html) \
[2019_visualization.html](../_layouts/2019_visualization.html) \
[2020_visualization.html](../_layouts/2020_visualization.html)
...
During the three season, from 2018 to 2020, we can observe similar trends in the shot locations of the Buffalo Sabres. They have an average shooting rate to less than average in the majority of the rink. The biggest difference is observed around the goal net where they have less shots than average. The red areas are very small and concentrated on the left and right edges of the rink, specially from 2019 to 2021.

For Tampa Bay, in the 2018-2019 season, they also shot less than average around the goal net, but unlike Buffalo Sabres they had more shots than average in the center area of the rink. However, in 2019-20, the difference between their shot rate and average was smaller, where the area around the goal is a lighter blue to white, and then shot more than average in that location in 2020-21 but there was a smaller difference in the center area of the rink. In both of these last seasons, they won the stanley cup.

From these observations, we could hypothesize that the Buffalo Sabres struggle comes from having less than average shot rate around the goal but also in the majority of the center rink, since  in 2018-19, even if Tampa Bay had a smaller shot rate than average around the goal they stil had a better ranking than Buffalo Sabres. Therefore, what would explain Tampa Bay’s success is their shot rate around the center area of the rinkr and then around the goal for the last season.
